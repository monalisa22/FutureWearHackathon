...
#     global data_sys,data_dia,data_bp,data_temp,data_HR,data_SD,data_step
#     data_sys= database.child('esp32_data').child('systolic').get().val()
#     data_dia= database.child('esp32_data').child('diastolic').get().val()
#     data_bp= database.child('esp32_data').child('bp').get().val()
#     data_temp= database.child('esp32_data').child('temperature').get().val()
#     data_HR= database.child('esp32_data').child('Heartrate').get().val()
#     data_SD= database.child('esp32_data').child('sleep disorder').get().val()
#     data_step= database.child('esp32_data').child('steps').get().val()
#     return render(request,'index.html', {
#         "systolic":data_sys,
#         "diastolic":data_dia,
#         "bp":data_bp,
#         "temperature":data_temp,
#         "sleep disorder":data_SD,
#         "heartrate":data_HR,
#         "steps":data_step,
#     }
#     )
...
def predict():
    ...
    # data_bp= database.child('bp').get().val()
    ...
    # return render_template("index.html", data_sys=age)
